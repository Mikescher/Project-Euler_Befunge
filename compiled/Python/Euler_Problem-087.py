...
def _12():
    sp()
    sa(sp()+1);
    return (13)if(sr()!=gr(8,0))else(14)
def _13():
    global t0
    sa(sr())
    sa(2)
...
def _18():
    ...
    sa(sp()*sp());
    sa(sp()+gr(7,0));
    return (23)if(sr()>gr(9,0))else(19)
def _19():
    global t0
    global t1
    global t2
...
def _25():
    ...
    return 26
def _26():
    return (28)if(sr()>=gr(3,0))else(27)
def _27():
    sa(sr())
    sa(32)
    v0=sp()
