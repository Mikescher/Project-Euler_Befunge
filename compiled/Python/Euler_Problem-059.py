...
def _6():
    ...
    return 7
def _7():
    return (8)if(gr(1,1)+gr(2,1)==0)else(35)
def _8():
...
def _18():
    ...
    return 11
def _19():
    return (34)if(sr()>126)else(20)
def _20():
    sa(gr(1,4))
    gw(1,4,gr(1,4)+1)
    sa(sp()-9);
    return (21)if(sp()!=0)else(33)
def _21():
    sa(sp()-32);
...
def _22():
    ...
    v0=sp()
    sa(gr(sp(),v0))
    return (23)if(sr()<32)else(24)
def _23():
    sp()
    return 11
def _24():
    return (31)if(sr()>126)else(25)
def _25():
    sa(sp()-101);
