...
def _1():
    ...
    gw(3,0,gr(3,0)+1)
    sa(gr(2,0)+1)
    return (2)if((gr(2,0)+1)-12)else(36)
def _2():
    gw(2,0,sp())
    return 3
def _3():
...
def _6():
    ...
    return 7
def _7():
    return (8)if((0)if(gr(1,1)+gr(2,1)!=0)else(1))else(35)
def _8():
...
def _16():
    ...
    sa((1)if((32)>(gr(gr(8,12)+109,gr(gr(2,4),2))))else(0))
    return 17
def _17():
    return (34)if(sp()!=0)else(18)
def _18():
    sa(sr())
    sa(126)
    v0=sp()
    sa((1)if(sp()>v0)else(0))
    return (33)if(sp()!=0)else(19)
def _19():
    sa(gr(1,4))
    gw(1,4,gr(1,4)+1)
    sa(9)
    v0=sp()
    sa(sp()-v0)
    return (20)if(sp()!=0)else(32)
def _20():
    sa(32)
    v0=sp()
    sa(sp()-v0)
    return (31)if(sp()!=0)else(21)
def _21():
    sa(sr())
    sa(3)
    v0=sp()
