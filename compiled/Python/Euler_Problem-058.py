...
def _4():
    ...
    return (38)if(sp()!=0)else(5)
def _5():
    sa(sr())
    sa(tm(sp(),3))
    sa((0)if(sp()!=0)else(1))
    return (37)if(sp()!=0)else(6)
def _6():
    sa(sr())
    sa(tm(sp(),5))
    sa((0)if(sp()!=0)else(1))
    return (37)if(sp()!=0)else(7)
def _7():
    global x4
    x4=1
    sa(-2)
