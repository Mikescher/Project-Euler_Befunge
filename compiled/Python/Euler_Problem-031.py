...
def _2():
    ...
    return (10)if(((gr(1,0)*500)+(gr(2,0)*200)+(100*gr(3,0))+(gr(4,0)*50)+(gr(5,0)*20)+(gr(6,0)*10)+(gr(7,0)*5)+(gr(8,0)*2)+gr(9,0))<gr(1,1))else(3)
def _3():
    global t0
    global t0
    t0=t0-gr(1,1)
    return (4)if((t0)!=0)else(9)
def _4():
    global t0
    t0=gr(2,1)
    return (6)if((gr(gr(2,1),0))!=0)else(5)
def _5():
    global t0
    global t0
    t0=t0-1
