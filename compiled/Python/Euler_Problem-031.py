...
def _9():
    ...
    return (2)if((1)if((gr(1,1))>((((((((((gr(1,0))*(500))+((gr(2,0))*(200)))+((100)*(gr(3,0))))+((gr(4,0))*(50)))+((gr(5,0))*(20)))+((gr(6,0))*(10)))+((gr(7,0))*(5)))+((gr(8,0))*(2)))+(gr(9,0))))else(0))else(8)
def _10():
    sa(sr())
    sa(1)
    v0=sp()
...
def _11():
    sa(gr(2,1))
    return (10)if(gr(gr(2,1),0))else(4)
