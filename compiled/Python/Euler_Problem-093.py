...
def _3():
    ...
    t0=t0-5
    t0=t0-5
    return (185)if((t0)!=0)else(4)
def _4():
    global t0
    t0=gr(4,0)+1
    gw(4,0,gr(4,0)+1)
    t0=t0-9
    return (184)if((t0)!=0)else(5)
def _5():
    global t0
    t0=gr(3,0)+1
    gw(3,0,gr(3,0)+1)
    t0=t0-8
    return (183)if((t0)!=0)else(6)
def _6():
    global t0
    t0=gr(2,0)+1
    gw(2,0,gr(2,0)+1)
...
def _20():
    ...
    gw(7,6,gr(7,6)+1)
    sa(sr())
    return (21)if(sp()!=0)else(182)
def _21():
    sa(sp()-1);
    sa(sr())
    return (22)if(sp()!=0)else(181)
def _22():
    sa(sp()-1);
    sa(sr())
    return (23)if(sp()!=0)else(180)
def _23():
    sa(sp()-1);
    sa(sr())
    return (24)if(sp()!=0)else(179)
def _24():
    sa(sp()-1);
    sa(sr())
    return (25)if(sp()!=0)else(178)
def _25():
    sa(sp()-1);
    sa(sr())
    return (26)if(sp()!=0)else(177)
def _26():
    sa(sp()-1);
    sa(sr())
    return (27)if(sp()!=0)else(176)
def _27():
    sa(sp()-1);
    sa(sr())
    return (28)if(sp()!=0)else(175)
def _28():
    sa(sp()-1);
    sa(sr())
    return (29)if(sp()!=0)else(174)
def _29():
    sa(sp()-1);
    sa(sr())
    return (30)if(sp()!=0)else(173)
def _30():
    sa(sp()-1);
    sa(sr())
    return (31)if(sp()!=0)else(172)
def _31():
    sa(sp()-1);
    sa(sr())
    return (32)if(sp()!=0)else(171)
def _32():
    sa(sp()-1);
    sa(sr())
    return (33)if(sp()!=0)else(182)
def _33():
    sa(sp()-1);
    sa(sr())
    return (34)if(sp()!=0)else(181)
def _34():
    sa(sp()-1);
    sa(sr())
    return (35)if(sp()!=0)else(180)
def _35():
    sa(sp()-1);
    sa(sr())
    return (36)if(sp()!=0)else(179)
def _36():
    sa(sp()-1);
    sa(sr())
    return (37)if(sp()!=0)else(178)
def _37():
    sa(sp()-1);
    sa(sr())
    return (38)if(sp()!=0)else(177)
def _38():
    sa(sp()-1);
    sa(sr())
    return (39)if(sp()!=0)else(176)
def _39():
    sa(sp()-1);
    sa(sr())
    return (40)if(sp()!=0)else(175)
def _40():
    sa(sp()-1);
    sa(sr())
    return (41)if(sp()!=0)else(174)
def _41():
    sa(sp()-1);
    sa(sr())
    return (42)if(sp()!=0)else(173)
def _42():
    sa(sp()-1);
    sa(sr())
    return (43)if(sp()!=0)else(172)
def _43():
    sa(sp()-1);
    sa(sr())
    return (44)if(sp()!=0)else(171)
def _44():
    sa(sp()-1);
    sa(sr())
    return (45)if(sp()!=0)else(170)
def _45():
    sa(sp()-1);
    sa(sr())
    return (46)if(sp()!=0)else(169)
def _46():
    sa(sp()-1);
    sa(sr())
    return (47)if(sp()!=0)else(168)
def _47():
    sa(sp()-1);
    sa(sr())
    return (48)if(sp()!=0)else(167)
def _48():
    sa(sp()-1);
    sa(sr())
    return (49)if(sp()!=0)else(166)
def _49():
    sa(sp()-1);
    sa(sr())
    return (50)if(sp()!=0)else(165)
def _50():
    sa(sp()-1);
    sa(sr())
    return (51)if(sp()!=0)else(164)
def _51():
    sa(sp()-1);
    sa(sr())
    return (52)if(sp()!=0)else(163)
def _52():
    sa(sp()-1);
    sa(sr())
    return (53)if(sp()!=0)else(162)
def _53():
    sa(sp()-1);
    sa(sr())
    return (54)if(sp()!=0)else(161)
def _54():
    sa(sp()-1);
    sa(sr())
    return (55)if(sp()!=0)else(160)
def _55():
    sa(sp()-1);
    sa(sr())
    return (56)if(sp()!=0)else(159)
def _56():
    sa(sp()-1);
    sa(sr())
    return (57)if(sp()!=0)else(157)
def _57():
    sa(sp()-1);
    sa(sr())
    return (58)if(sp()!=0)else(155)
def _58():
    sa(sp()-1);
    sa(sr())
    return (59)if(sp()!=0)else(153)
def _59():
    sa(sp()-1);
    sa(sr())
    return (60)if(sp()!=0)else(151)
def _60():
    sa(sp()-1);
    sa(sr())
    return (61)if(sp()!=0)else(149)
def _61():
    sa(sp()-1);
    sa(sr())
    return (62)if(sp()!=0)else(147)
def _62():
    sa(sp()-1);
    sa(sr())
    return (63)if(sp()!=0)else(145)
def _63():
    sa(sp()-1);
    sa(sr())
    return (64)if(sp()!=0)else(143)
def _64():
    sa(sp()-1);
    sa(sr())
    return (65)if(sp()!=0)else(141)
def _65():
    sa(sp()-1);
    sa(sr())
    return (66)if(sp()!=0)else(139)
def _66():
    sa(sp()-1);
    sa(sr())
    return (67)if(sp()!=0)else(137)
def _67():
    sa(sp()-1);
    sa(sr())
    return (136)if(sp()!=0)else(68)
def _68():
    sp()
...
def _70():
    ...
    gw(7,7,gr(7,7)+1)
    sa(sr())
    return (71)if(sp()!=0)else(135)
def _71():
    sa(sp()-1);
    sa(sr())
    return (72)if(sp()!=0)else(134)
def _72():
    sa(sp()-1);
    sa(sr())
    return (73)if(sp()!=0)else(133)
def _73():
    sa(sp()-1);
    sa(sr())
    return (74)if(sp()!=0)else(132)
def _74():
    sa(sp()-1);
    sa(sr())
    return (75)if(sp()!=0)else(131)
def _75():
    sa(sp()-1);
    sa(sr())
    return (76)if(sp()!=0)else(130)
def _76():
    sa(sp()-1);
    sa(sr())
    return (77)if(sp()!=0)else(135)
def _77():
    sa(sp()-1);
    sa(sr())
    return (78)if(sp()!=0)else(134)
def _78():
    sa(sp()-1);
    sa(sr())
    return (79)if(sp()!=0)else(133)
def _79():
    sa(sp()-1);
    sa(sr())
    return (80)if(sp()!=0)else(132)
def _80():
    sa(sp()-1);
    sa(sr())
    return (81)if(sp()!=0)else(131)
def _81():
    sa(sp()-1);
    sa(sr())
    return (82)if(sp()!=0)else(130)
def _82():
    sa(sp()-1);
    sa(sr())
    return (83)if(sp()!=0)else(129)
def _83():
    sa(sp()-1);
    sa(sr())
    return (84)if(sp()!=0)else(128)
def _84():
    sa(sp()-1);
    sa(sr())
    return (85)if(sp()!=0)else(127)
def _85():
    sa(sp()-1);
    sa(sr())
    return (86)if(sp()!=0)else(126)
def _86():
    sa(sp()-1);
    sa(sr())
    return (87)if(sp()!=0)else(125)
def _87():
    sa(sp()-1);
    sa(sr())
    return (88)if(sp()!=0)else(124)
def _88():
    sa(sp()-1);
    sa(sr())
    return (89)if(sp()!=0)else(122)
def _89():
    sa(sp()-1);
    sa(sr())
    return (90)if(sp()!=0)else(120)
def _90():
    sa(sp()-1);
    sa(sr())
    return (91)if(sp()!=0)else(118)
def _91():
    sa(sp()-1);
    sa(sr())
    return (92)if(sp()!=0)else(116)
def _92():
    sa(sp()-1);
    sa(sr())
    return (93)if(sp()!=0)else(114)
def _93():
    sa(sp()-1);
    sa(sr())
    return (113)if(sp()!=0)else(94)
def _94():
    sp()
...
def _114():
    sp()
    return (95)if((gr(2,7))==0)else(115)
def _115():
    gw(7,8,0)
    gw(1,8,gr(2,7))
...
def _116():
    sp()
    return (95)if((gr(2,7))==0)else(117)
def _117():
    gw(7,8,0)
    gw(1,8,gr(1,7))
...
def _118():
    sp()
    return (95)if((gr(2,7))==0)else(119)
def _119():
    gw(7,8,0)
    gw(1,8,gr(3,7))
...
def _120():
    sp()
    return (95)if((gr(2,7))==0)else(121)
def _121():
    gw(7,8,0)
...
def _122():
    sp()
    return (95)if((gr(2,7))==0)else(123)
def _123():
    gw(7,8,0)
...
def _137():
    sp()
    return (20)if((gr(2,6))==0)else(138)
def _138():
    gw(7,7,0)
    gw(1,7,gr(1,6))
    gw(2,7,gr(3,6))
...
def _139():
    sp()
    return (20)if((gr(1,6))==0)else(140)
def _140():
    gw(7,7,0)
    gw(1,7,gr(3,6))
    gw(2,7,gr(2,6))
...
def _141():
    sp()
    return (20)if((gr(4,6))==0)else(142)
def _142():
    gw(7,7,0)
    gw(1,7,gr(1,6))
    gw(2,7,gr(2,6))
...
def _143():
    sp()
    return (20)if((gr(2,6))==0)else(144)
def _144():
    gw(7,7,0)
    gw(1,7,gr(1,6))
    gw(2,7,gr(4,6))
...
def _145():
    sp()
    return (20)if((gr(1,6))==0)else(146)
def _146():
    gw(7,7,0)
    gw(1,7,gr(4,6))
    gw(2,7,gr(2,6))
...
def _147():
    sp()
    return (20)if((gr(4,6))==0)else(148)
def _148():
    gw(7,7,0)
    gw(1,7,gr(1,6))
...
def _149():
    sp()
    return (20)if((gr(3,6))==0)else(150)
def _150():
    gw(7,7,0)
    gw(1,7,gr(1,6))
...
def _151():
    sp()
    return (20)if((gr(1,6))==0)else(152)
def _152():
    gw(7,7,0)
    gw(1,7,gr(4,6))
...
def _153():
    sp()
    return (20)if((gr(4,6))==0)else(154)
def _154():
    gw(7,7,0)
...
def _155():
    sp()
    return (20)if((gr(3,6))==0)else(156)
def _156():
    gw(7,7,0)
...
def _157():
    sp()
    return (20)if((gr(2,6))==0)else(158)
def _158():
    gw(7,7,0)
