...
def _7():
    ...
    return 8
def _8():
    return (9)if(sp()!=0)else(27)
def _9():
    sa(sp()+1)


    return (26)if((sr()-gr(4,0))!=0)else(10)
def _10():
    sp();
    sa(gr(3,0))
    gw(5,0,gr(3,0))
...
def _15():
    ...
    return (16)if((t2)!=0)else(23)
def _16():
    global t0
    t0=gr(1,1)-gr(4,1)
    gw(5,1,gr(1,1)-gr(4,1))

    return (17)if((t0)!=0)else(22)
def _17():
    gw(6,1,0)
    sa(gr(3,1))
...
def _22():
    ...
    return 21
def _23():
    return (24)if(gr(2,1)>gr(7,0))else(25)
def _24():
