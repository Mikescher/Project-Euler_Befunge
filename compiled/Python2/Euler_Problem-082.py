...
def _11():
    ...
    return (22)if(sr()!=-1)else(12)
def _12():
    sp();
    sa(sp()+1)


    return (21)if(sr()!=80)else(13)
def _13():
    sp();
    sa(sp()+1)


    return (14)if(sr()!=80)else(15)
def _14():
    sa(sr());
    gw(2,0,sp())
    return 5
