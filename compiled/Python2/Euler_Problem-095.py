...
def _7():
    gw(2,3,6)
    sp();
    sa((0)if((gr((td(6,gr(1,9)))+9,tm(6,gr(1,9))))!=0)else(1))
    return 8
def _8():
...
def _9():
    ...
    return (10)if((gr(2,3)+1)!=gr(3,9))else(11)
def _10():
    sa(sr());
    gw(2,3,sp())
    sa((td(sr(),gr(1,9)))+9)
...
def _20():
    return (21)if((gr((td(gr(2,2),gr(1,9)))+9,tm(gr(2,2),gr(1,9))))==0)else(9)
def _21():
    sa(gr(2,2))
    sa(gr(2,2))
    sa(7)
...
def _24():
    ...
    return (25)if(sr()!=gr(1,2))else(19)
def _25():
    sa(sr());
    sa(7)
    v0=sp()
