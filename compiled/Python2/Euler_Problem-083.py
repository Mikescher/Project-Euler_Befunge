...
def _4():
    ...
    return 5
def _5():
    return (6)if(gr(gr(4,0)+100,gr(5,0)+100)!=88)else(13)
def _6():
    sa(sp()+1);


    return (12)if(sr()!=80)else(7)
def _7():
    sp();
    sa(sp()+1);


    return (11)if(sr()!=80)else(8)
def _8():
    global t0
    sp();
    t0=gr(7,0)
...
def _13():
    ...
    t3=(1)if(t1>t2)else(0)
    t1=t0*t3

    return (20)if((t1)!=0)else(14)
def _14():
    global t0
    global t1
    global t2
    global t3
    t0=(1)if(gr(5,0)>0)else(0)
