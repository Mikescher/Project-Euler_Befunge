...
def _10():
    ...
    return (20)if((t0)!=0)else(11)
def _11():
    global t0
    t0=gr(7,0)

    return (19)if(gr(7,0)>gr(3,1))else(12)
def _12():
    global t0
    t0=gr(5,0)+2
    gw(5,0,gr(5,0)+2)
...
def _16():
    return (17)if(gr(6,0)>gr(4,0))else(18)
def _17():
    sys.stdout.write(str(gr(1,1)*gr(2,1))+" ")
    sys.stdout.flush()
    return 23
def _18():
    global t0
