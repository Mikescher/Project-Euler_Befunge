...
def _0():
    ...
    return 1
def _1():
    return (2)if(gr(0,2)!=1000)else(46)
def _2():
    global t0
    global t1
    t0=gr(0,2)+1
    ...
    return (3)if((t1)!=0)else(1)
def _3():
    global t0
    t0=t0%5

    return (4)if((t0)!=0)else(1)
def _4():
    gw(1,2,3)
    return 5
def _5():
...
def _14():
    ...
    return (16)if((sr()%2)!=0)else(15)
def _15():
    sp();
    return 7
def _16():
    return (17)if((sr()%3)!=0)else(15)
def _17():
    gw(5,2,sp())
    sa(7)
    sa(gr(5,2)%7)
...
def _19():
    return (22)if(sr()>(gr(5,2)/2))else(20)
def _20():
    sa(sr()-2)
    sa(gr(5,2))
    v0=sp()
...
def _29():
    ...
    return (33)if((sr()%2)!=0)else(30)
def _30():
    sp();
    sa(3)
    sp();

    return (23)if(gr(9,2)!=9)else(31)
def _31():
    sa(9)
    sa(2)
    sp();
    ...
    return (7)if(gr(8,2)!=8)else(32)
def _32():
    sys.stdout.write(str(gr(7,2))+" ")
    sys.stdout.flush()
    return 47
def _33():
    return (34)if((sr()%3)!=0)else(30)
def _34():
    gw(5,2,sp())
    sa(7)
    sa(gr(5,2)%7)
    return 35
def _35():
    return (36)if(sp()!=0)else(30)
def _36():
    return (39)if(sr()>(gr(5,2)/2))else(37)
def _37():
    sa(sr()-2)
    sa(gr(5,2))
    v0=sp()
