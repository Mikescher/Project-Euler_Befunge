...
_13:
    ...
    goto _3;
_14:
    if((((gr(0,2)-9!=0)?0:1)+((gr(0,2)-8!=0)?0:1)+((gr(0,2)-7!=0)?0LL:1LL)+(((gr(0,2)-6)+((((((gr(7,0)-48)*10)+(gr(8,0)-48))*10)+(gr(9,0)-48))%17)!=0)?0:1)+(((gr(0,2)-5)+((((((gr(6,0)-48)*10)+(gr(7,0)-48))*10)+(gr(8,0)-48))%13)!=0)?0:1)+(((gr(0,2)-4)+((((((gr(5,0)-48)*10)+(gr(6,0)-48))*10)+(gr(7,0)-48))%11)!=0)?0:1)+(((gr(0,2)-3)+((((((gr(4,0)-48)*10)+(gr(5,0)-48))*10)+(gr(6,0)-48))%7)!=0)?0:1)+(((gr(0,2)-2)+((((((gr(3,0)-48)*10)+(gr(4,0)-48))*10)+(gr(5,0)-48))%5)!=0)?0:1)+(((gr(0,2)-1)+((((((gr(2,0)-48)*10)+(gr(3,0)-48))*10)+(gr(4,0)-48))%3)!=0)?0:1)+((gr(0,2)+((((((gr(1,0)-48)*10)+(gr(2,0)-48))*10)+(gr(3,0)-48))%2)!=0)?0LL:1LL))!=0)goto _3;else goto _15;
_15:
