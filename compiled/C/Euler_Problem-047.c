...
_13:
    ...
    if((t1)!=0)goto _14;else goto _30;
_14:
    sp();

    if(gr(5,0)!=4)goto _20;else goto _15;
_15:
    gw(8,0,0);
    sa(sr());
    sa(sr());
    ...
    sa(sp()-3LL);
_16:
    if((sr()-gr(7,0))!=0)goto _22;else goto _17;
_17:
    t0=gr(8,0)-3;
    gw(8,0,gr(8,0)+1);
...
_18:
    ...
    if((sr()-gr(6,0))!=0)goto _16;else goto _19;
_19:
    sp();
_20:
    gw(4,0,0);
...
_24:
    ...
    if((t1)!=0)goto _25;else goto _23;
_25:
    sp();
