...
_3:
    ...
    sp();
_4:
    if(gr(3,2)>gr(gr(3,2),1))goto _7;else goto _5;
_5:
    gw(gr(3,2),1,0);
_6:
    gw(3,2,gr(3,2)+1);
    goto _4;
_7:
    if((gr(3,2)%2)!=0)goto _17;else goto _8;
_8:
    gw(4,2,0);
_9:
    sa(gr(gr(4,2),0));
...
_10:
    ...
    if((gr(6,2))!=0)goto _16;else goto _11;
_11:
    gw(0,2,3);
    sa(sr());
    sa(sr());
...
_12:
    ...
    goto _6;
_13:
    if(sr()>((gr(0,2)-2)*(gr(0,2)-2)))goto _14;else goto _15;
_14:
    sa(tm(sr(),gr(0,2)));
    gw(0,2,gr(0,2)+1);
