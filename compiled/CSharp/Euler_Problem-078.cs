...
private static long gr(long x,long y){return(x>=0&&y>=0&&x<251&&y<256)?g[y*251+x]:0;}
private static void gw(long x,long y,long v){if(x>=0&&y>=0&&x<251&&y<256)g[y*251+x]=v;}
