...
{
private static readonly string _g = "AR+LCAAAAAAABADVnbuuJMdyRX+lL3StmS6h8p1JEBf6A7myKHnHHYuWPl6xdtShBEjWbksH4nA4V0xWd2VGxmM/7rv9+sdd+GW0X3eNv1r7VXr8QW1fpX2dn1+/jfPj"+
...
private static long gr(long x,long y){return(x>=0&&y>=0&&x<80&&y<1009)?g[y*80+x]:0;}
private static void gw(long x,long y,long v){if(x>=0&&y>=0&&x<80&&y<1009)g[y*80+x]=v;}
...
static void Main(string[]args)
{
    ...
    _2:
        ...
        if(gr(gr(2,3),gr(1,3)+9)!=45)goto _5;else goto _3;
    _3:
        gw(4,3,-1);
    _4:
        gw(2,3,gr(2,3)+1);
    ...
    _6:
        ...
        if((t0)!=0)goto _1;else goto _7;
    _7:
        System.Console.Out.Write(gr(0,3)+" ");
        return;
    _8:
        if(t0!=44)goto _10;else goto _9;
    _9:
        sa(gr(3,3)*gr(4,3));
        sa(gr(5,3));
        gw(5,3,gr(5,3)+1);
