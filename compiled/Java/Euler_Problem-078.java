...
private long[]zc(byte[]b){long[]r=new long[64256];for(int i=0;i<64256;i++)r[i]=b[i];return r;}
...
private long gr(long x,long y){return(x>=0&&y>=0&&x<251&&y<256)?g[(int)(y*251+x)]:0;}
private void gw(long x,long y,long v){if(x>=0&&y>=0&&x<251&&y<256)g[(int)(y*251+x)]=v;}
...
private int _2(){
    if(sp()!=0)return 3;else return 6;
}
private int _3(){
    sp();
    sp();
