...
private int _1(){
    if(sp()!=0)return 2;else return 15;
}
private int _2(){
    t0=gr(2,0);
    sa(sr());
    ...
    if((t1)!=0)return 14;else return 3;
}
private int _3(){
    sa(sr());
    gw(3,0,sp());
...
private int _6(){
    ...
    if(sp()!=0)return 13;else return 7;
}
private int _7(){
    gw(0,1,0);
    gw(2,0,gr(0,0)-1);
...
private int _8(){
    ...
    if((gr(2,0)-gr(5,0))!=0)return 9;else return 11;
}
private int _9(){
    t2=gr(2,0);
    gw(2,0,gr(2,0)-1);

    if((t2)!=0)return 8;else return 10;
}
private int _10(){
...
private int _11(){
    if(gr(2,0)>gr(4,0))return 12;else return 9;
}
private int _12(){
