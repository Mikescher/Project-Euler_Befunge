...
class Program{
private final static String _g = "AR+LCAAAAAAABADFmMtuZUkRRX/FbcPIWJWvyEepsJgw5wtcElCyhBphtcAjPp610l0+SVE8Zljtct9zT2bGY8eOHfl648+HDze/++kvf/ryh7/e/PZvP3756ebBz7//"+
...
private long[]zc(byte[]b){long[]r=new long[6667];for(int i=0;i<6667;i++)r[i]=b[i];return r;}
...
private long gr(long x,long y){return(x>=0&&y>=0&&x<59&&y<113)?g[(int)(y*59+x)]:0;}
private void gw(long x,long y,long v){if(x>=0&&y>=0&&x<59&&y<113)g[(int)(y*59+x)]=v;}
...
private int _1(){
    ...
    if((t0)!=0)return 15;else return 2;
}
private int _2(){
    gw(1,0,5);
    t0=gr(2,0)-1;
    ...
    if((t0)!=0)return 15;else return 3;
}
private int _3(){
    gw(1,0,55);
    gw(2,0,1);
...
private int _4(){
    if(gr(gr(1,0),gr(2,0))-32==0)return 8;else return 5;
}
private int _5(){
...
private int _6(){
    if(gr(gr(1,0),gr(2,0))!=32)return 5;else return 7;
}
private int _7(){
    t0=gr(0,0);
...
private int _10(){
    if((t0)!=0)return 9;else return 11;
}
private int _11(){
    gw(0,0,10);
    return 12;
...
private int _12(){
    ...
    if((t0)!=0)return 13;else return 14;
}
private int _13(){
    return 16;
}
private int _14(){
    System.out.print(String.valueOf((char)(gr((9-gr(0,0))+gr(1,0),gr(2,0)))));
    return 12;
}
private int _15(){
