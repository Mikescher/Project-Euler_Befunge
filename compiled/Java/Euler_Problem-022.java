...
private long[]zc(byte[]b){long[]r=new long[562876];for(int i=0;i<562876;i++)r[i]=b[i];return r;}
...
private long gr(long x,long y){return(x>=0&&y>=0&&x<109&&y<5164)?g[(int)(y*109+x)]:0;}
private void gw(long x,long y,long v){if(x>=0&&y>=0&&x<109&&y<5164)g[(int)(y*109+x)]=v;}
...
private int _2(){
    if(sp()!=0)return 22;else return 3;
}
private int _3(){
    gw(1,0,gr(1,0)*28);
    sp();
...
private int _4(){
    ...
    if(sr()!=12)return 21;else return 5;
}
private int _5(){
    gw(0,gr(0,0),gr(1,0));
    t0=gr(0,0)-1;
...
private int _8(){
    if(gr(0,gr(4,0)+1)>gr(0,gr(4,0)+2))return 17;else return 9;
}
private int _9(){
    t0=gr(4,0)+1;
    gw(4,0,gr(4,0)+1);
...
private int _18(){
    ...
    if((t0)!=0)return 20;else return 19;
}
private int _19(){
    sp();
    return 9;
