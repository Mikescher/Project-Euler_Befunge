...
private int _9(){
    if(sp()!=0)return 10;else return 26;
}
private int _10(){
    sa(sr());
    sa(tm(sr(),gr(1,0)));
    ...
    if((t0)!=0)return 26;else return 11;
}
private int _11(){
    sa(sr());

    if(sr()<10)return 12;else return 19;
}
private int _12(){
    sp();
    sa((sp()!=0)?0:1);
...
private int _15(){
    if(sr()!=1)return 18;else return 16;
}
private int _16(){
    sp();
    sa(sr());
...
private int _23(){
    ...
    if((t0)!=0)return 13;else return 24;
}
private int _24(){
    {long v0=sp();long v1=sp();sa(v0);sa(v1);}
    sa(sr());
