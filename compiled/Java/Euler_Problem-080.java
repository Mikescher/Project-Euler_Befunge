...
private int _2(){
    if(sp()!=0)return 3;else return 27;
}
private int _3(){
    sa(sp()-1L);
...
private int _6(){
    ...
    if(sp()!=0)return 35;else return 7;
}
private int _7(){
    sp();
    gw(68,1,sp());
...
private int _9(){
    ...
    if(sp()!=0)return 34;else return 10;
}
private int _10(){
    sp();
    sa(0);
...
private int _15(){
    ...
    if((t2)!=0)return 14;else return 16;
}
private int _16(){
    gw(2,0,gr(2,0)-1);
    gw(68,5,0);
...
private int _18(){
    if(gr(7,0)<=gr(6,0))return 19;else return 33;
}
private int _19(){
    gw(4,0,t0);
    sa(gr(6,0)-gr(7,0));
    ...
    if(sp()!=0)return 21;else return 20;
}
private int _20(){
    sa(sr());
    sa(sr()+9);
...
private int _22(){
    ...
    if(sp()!=0)return 32;else return 23;
}
private int _23(){
...
private int _25(){
    if(sr()!=59)return 24;else return 26;
}
private int _26(){
    ...
    if(sp()!=0)return 27;else return 31;
}
private int _27(){
    sp();
    return 28;
