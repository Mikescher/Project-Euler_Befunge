...
class Program{
private final static String _g = "AR+LCAAAAAAABADFnU9z2ziTh78KY2f2EJd3LDvZd+JKuZYiQQkxSXAAUorecmXmsFW+bbn24FM+/HaDEtG/jjJJJhkRhySPSCn4j+5Go/H84cOH7DzLsvMTpPgf5Rmm"+
...
private long[]zc(byte[]b){long[]r=new long[51342];for(int i=0;i<51342;i++)r[i]=b[i];return r;}
...
private long gr(long x,long y){return(x>=0&&y>=0&&x<258&&y<199)?g[(int)(y*258+x)]:0;}
private void gw(long x,long y,long v){if(x>=0&&y>=0&&x<258&&y<199)g[(int)(y*258+x)]=v;}
...
private int _1(){
    if(sp()!=0)return 95;else return 2;
}
private int _2(){
    sp();
    sp();
...
private int _3(){
    if(sp()!=0)return 4;else return 87;
}
private int _4(){
    sp();
    {long v0=sp();long v1=sp();sa(v0);sa(v1);}
    ...
    if(sr()!=1786)return 5;else return 6;
}
private int _5(){
    sa(sr());
    sa(sr());
...
private int _8(){
    if((gr((gr(1,1)%100)+9,gr(1,1)/100)-gr((gr(2,1)%100)+9,gr(2,1)/100))!=0)return 9;else return 12;
}
private int _9(){
    t0=(gr(2,1)+1)>1786?1:0;
    gw(2,1,gr(2,1)+1);

    if((t0)!=0)return 10;else return 8;
}
private int _10(){
    t0=gr(1,1)+1;
    t1=gr(1,1)+1;
...
private int _11(){
    System.out.print(String.valueOf(gr(1,9))+" ");
    return 96;
}
private int _12(){
    sa(0);
...
private int _13(){
    ...
    if((t0)!=0)return 14;else return 15;
}
private int _14(){
    {long v0=sp();long v1=sp();sa(v0);sa(v1);}
    sa(sp()+1L);
...
private int _16(){
    ...
    if(sp()!=0)return 86;else return 17;
}
private int _17(){
    sp();
    return 18;
...
private int _18(){
    ...
    if(sp()!=0)return 19;else return 20;
}
private int _19(){
    {long v0=sp();long v1=sp();sa(v0);sa(v1);}
    sa(sp()*sp());
...
private int _21(){
    ...
    if(sp()!=0)return 85;else return 22;
}
private int _22(){
    sp();
    return 23;
...
private int _26(){
    ...
    if((sr()-gr(3,0))!=0)return 83;else return 27;
}
private int _27(){
    gw(1,2,gr(3,0)+1);
    gw(1,0,0);
...
private int _28(){
    ...
    if((sr()-gr(3,0))!=0)return 81;else return 29;
}
private int _29(){
    gw(2,2,gr(3,0));
    sp();
...
private int _30(){
    ...
    if(sp()!=0)return 9;else return 31;
}
private int _31(){
...
private int _32(){
    if(sp()!=0)return 33;else return 34;
}
private int _33(){
    sa(sr());
    sa(124);
...
private int _35(){
    if(sp()!=0)return 36;else return 37;
}
private int _36(){
    sa(sr());
    sa(124);
...
private int _39(){
    if(sp()!=0)return 80;else return 40;
}
private int _40(){
    sp();
    sa(sr());

    if(sp()!=0)return 41;else return 79;
}
private int _41(){
    {long v0=sp();long v1=sp();sa(v0);sa(v1);}
    sa(sr());

    if(sp()!=0)return 78;else return 42;
}
private int _42(){
    sp();
    sa(gr(2,3));
    ...
    if(gr(110,gr(2,4))!=124)return 43;else return 77;
}
private int _43(){
    sa(sp()-gr(3,4));


    if(sp()!=0)return 49;else return 44;
}
private int _44(){
    gw(110,gr(2,4),gr(3,4));
    sa(gr(5,gr(3,4)));

    if(gr(5,gr(3,4))!=124)return 45;else return 76;
}
private int _45(){
    sa(sp()-gr(2,4));


    if(sp()!=0)return 49;else return 46;
}
private int _46(){
    ...
    if(sp()!=0)return 38;else return 47;
}
private int _47(){
    gw(1,5,0);
    gw(1,4,0);
...
private int _48(){
    ...
    if(gr(110,gr(2,4))!=124)return 50;else return 49;
}
private int _49(){
    sa(gr(1,3)+1);
    sa(gr(1,3)+1);
...
private int _50(){
    if((gr(110,gr(2,4))+gr(1,4))!=0)return 51;else return 49;
}
private int _51(){
...
private int _52(){
    if(((gr(1,5)>gr(2,3)?1:0)*(gr(1,5)>gr(1,9)?1L:0L))!=0)return 53;else return 49;
}
private int _53(){
    sa(gr(1,5));

    if((gr(1,5)%64)>57)return 75;else return 54;
}
private int _54(){
    sa(sr()%16);

    if(sr()>9)return 55;else return 59;
}
private int _55(){
    sp();
    return 56;
...
private int _57(){
    if(sp()!=0)return 58;else return 49;
}
private int _58(){
    gw(1,9,gr(1,5));
    return 49;
...
private int _59(){
    if(sr()!=2)return 60;else return 55;
}
private int _60(){
    if(sr()!=3)return 61;else return 55;
}
private int _61(){
    if(sr()!=5)return 62;else return 55;
}
private int _62(){
    if(sr()!=6)return 63;else return 55;
}
private int _63(){
    if(sr()!=7)return 64;else return 55;
}
private int _64(){
    sa(sp()-8L);


    if(sp()!=0)return 65;else return 75;
}
private int _65(){
    sa(sr()%10);

    if(sr()!=7)return 66;else return 55;
}
private int _66(){
    if(sr()!=3)return 67;else return 55;
}
private int _67(){
    sa(sp()-2L);


    if(sp()!=0)return 69;else return 68;
}
private int _68(){
    sa(0);
    return 55;
...
private int _69(){
    if((sr()%3)!=2)return 70;else return 56;
}
private int _70(){
    gw(1,0,0);
    sa(sr());
...
private int _71(){
    ...
    if((sr()-gr(3,0))!=0)return 73;else return 72;
}
private int _72(){
    sp();
...
private int _73(){
    if((sr()-gr(1,0))!=0)return 74;else return 72;
}
private int _74(){
    gw(1,0,gr(3,0));
    return 71;
...
private int _81(){
    if((sr()-gr(1,0))!=0)return 82;else return 29;
}
private int _82(){
    gw(1,0,gr(3,0));
    return 28;
...
private int _83(){
    if((sr()-gr(1,0))!=0)return 84;else return 27;
}
private int _84(){
    gw(1,0,gr(3,0));
    return 26;
...
private int _88(){
    if(sp()!=0)return 94;else return 89;
}
private int _89(){
    sp();
    sa(sr());

    if(sp()!=0)return 90;else return 93;
}
private int _90(){
    {long v0=sp();long v1=sp();sa(v0);sa(v1);}
    sa(sr());

    if(sp()!=0)return 91;else return 92;
}
private int _91(){
    {long v0=sp();long v1=sp();sa(v0);sa(v1);}
    sa(sp()*sp());
