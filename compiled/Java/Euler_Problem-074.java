...
private int _1(){
    ...
    if(sp()!=0)return 26;else return 2;
}
private int _2(){
    gw(7,0,0);
    sp();
...
private int _4(){
    if(gr(7,0)!=10)return 3;else return 5;
}
private int _5(){
    gw(0,4,0);
...
private int _6(){
    if(gr(gr(3,2)+9,2)!=gr(1,2))return 7;else return 13;
}
private int _7(){
    sa(gr(1,2));
    sa(gr(2,2)+1);
...
private int _17(){
    if(sr()!=gr(3,2))return 21;else return 18;
}
private int _18(){
    sp();

    if(sr()!=gr(3,1))return 20;else return 19;
}
private int _19(){
