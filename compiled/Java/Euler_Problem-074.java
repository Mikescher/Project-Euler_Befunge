...
class Program{
private final static String _g = "Ah+LCAAAAAAABADtmVc4nG/378eM3vuI3oIUDBmjRY/eJaL3SHRGLzEE0UWCJKJEjQhiCBGd0aJGDZMYwahRRtTBGLZf+R+8Z/vk3de1r73vk/u71vo833U/1zpcfCmU"+
...
private long[]zc(byte[]b){long[]r=new long[1019592];for(int i=0;i<1019592;i++)r[i]=b[i];return r;}
...
private long gr(long x,long y){return(x>=0&&y>=0&&x<1224&&y<833)?g[(int)(y*1224+x)]:0;}
private void gw(long x,long y,long v){if(x>=0&&y>=0&&x<1224&&y<833)g[(int)(y*1224+x)]=v;}
...
private int _1(){
    if(sp()!=0)return 27;else return 2;
}
private int _2(){
    gw(7,0,0);
    sp();
...
private int _3(){
    ...
    if(gr(7,0)!=10)return 26;else return 4;
}
private int _4(){
    gw(0,4,0);
...
private int _6(){
    if((gr(gr(3,2)+9,2)-gr(1,2))!=0)return 7;else return 13;
}
private int _7(){
    sa(gr(1,2));
    sa(gr(2,2)+10);
    ...
    if((gr(1,2))!=0)return 24;else return 8;
}
private int _8(){
    sp();
    return 9;
...
private int _9(){
    ...
    if(sp()!=0)return 23;else return 10;
}
private int _10(){
    sa(sp()+sp());
    ...
    if(sp()!=0)return 6;else return 11;
}
private int _11(){
    t0=gr(tm(gr(1,2),gr(1,1)),(td(gr(1,2),gr(1,1)))+4);

    if((gr(tm(gr(1,2),gr(1,1)),(td(gr(1,2),gr(1,1)))+4))!=0)return 12;else return 6;
}
private int _12(){
    t0+=gr(2,2);
    gw(2,2,t0);
...
private int _13(){
    if(gr(2,2)!=60)return 14;else return 22;
}
private int _14(){
    sa(1);
...
private int _17(){
    if((sr()-gr(3,2))!=0)return 21;else return 18;
}
private int _18(){
    sp();

    if((sr()-gr(3,1))!=0)return 20;else return 19;
}
private int _19(){
...
private int _25(){
    if(sp()!=0)return 24;else return 8;
}
private int _26(){
    sa(sr());
    return 3;
