...
private int _7(){
    if(sp()!=0)return 12;else return 8;
}
private int _8(){
    sp();
    sp();
...
private int _9(){
    if(sp()!=0)return 11;else return 10;
}
private int _10(){
...
private int _13(){
    if(sr()!=89)return 19;else return 14;
}
private int _14(){
    gw(3,0,gr(3,0)+1);
    return 15;
...
private int _16(){
    if((gr(2,0))!=0)return 18;else return 17;
}
private int _17(){
    sp();
    sa(sp()-1L);
...
private int _19(){
    if(sr()!=1)return 20;else return 15;
}
private int _20(){
    sp();
    return 6;
