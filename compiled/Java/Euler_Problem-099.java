...
class Program{
private final static String _g = "AR+LCAAAAAAABACdXcGSHbmN/JU30pykN2uCIAFCoejwZ+xBIc+trzrpNPPvm4nqcTjs6FhXti8bXlP1ikUCCSCR+Plr/z3++79ttXw+99xnxON///fxGOPnP/+/v379"+
...
private long[]zc(byte[]b){long[]r=new long[63000];for(int i=0;i<63000;i++)r[i]=b[i];return r;}
...
private long gr(long x,long y){return(x>=0&&y>=0&&x<63&&y<1000)?g[(int)(y*63+x)]:0;}
private void gw(long x,long y,long v){if(x>=0&&y>=0&&x<63&&y<1000)g[(int)(y*63+x)]=v;}
...
private int _1(){
    ...
    sa(50);
    sa(gr(50,gr(1,1)));
    sa((gr(50,gr(1,1))-32)<=0?1:0);
    return 2;
}
private int _2(){
    if(sp()!=0)return 3;else return 23;
}
private int _3(){
    sp();
    sp();
...
private int _5(){
    if(sp()!=0)return 6;else return 21;
}
private int _6(){
    sp();
    sa(sr());
...
private int _7(){
    ...
    if(sp()!=0)return 20;else return 8;
}
private int _8(){
    sp();
    gw(3,0,sp());
...
private int _9(){
    ...
    if(gr(3,0)<=1000000)return 10;else return 13;
}
private int _10(){
    sp();
    ...
    if(sr()>gr(6,1))return 12;else return 11;
}
private int _11(){
    sp();
    return 1;
...
private int _13(){
    if(2000000<=gr(3,0))return 15;else return 14;
}
private int _14(){
    gw(3,0,td(gr(3,0)*gr(3,0),1000000));
    sa(sp()+1L);
    return 13;
}
private int _15(){
...
private int _23(){
    if(sr()!=44)return 25;else return 24;
}
private int _24(){
    sp();
    sa(0);
...
private int _25(){
    ...
    sa((gr(gr(2,1)+1,gr(1,1))-32)<=0?1:0);
    return 2;
}
