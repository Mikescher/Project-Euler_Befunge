...
private int _2(){
    if(sp()!=0)return 24;else return 3;
}
private int _3(){
    sp();
    sp();
...
private int _5(){
    if(sp()!=0)return 6;else return 22;
}
private int _6(){
    sp();
    sa(sr());
...
private int _9(){
    ...
    if(gr(3,0)>1000000)return 13;else return 10;
}
private int _10(){
    sp();
...
private int _13(){
    if(2000000>gr(3,0))return 14;else return 15;
}
private int _14(){
...
private int _24(){
    if(sr()!=44)return 26;else return 25;
}
private int _25(){
    sp();
    sa(0);
