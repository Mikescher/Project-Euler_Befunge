...
private int _2(){
    ...
    if((sr()-gr(1,1))!=0)return 4;else return 3;
}
private int _3(){
...
private int _5(){
    if((gr(tm(sr(),gr(2,1)),gr(7,1)+3))!=0)return 6;else return 9;
}
private int _6(){
    gw(5,1,gr(5,1)+1);
    sa(sr());
...
private int _7(){
    if(((gr(8,1)>gr(1,1)?1:0)+(gr(9,1)>gr(1,1)?1L:0L))!=0)return 9;else return 8;
}
private int _8(){
