...
private int _5(){
    if(sp()!=0)return 6;else return 8;
}
private int _6(){
    sa(395-gr(2,0));

    if((395-gr(2,0))>gr(1,1))return 21;else return 7;
}
private int _7(){
    sp();
    return 8;
...
private int _8(){
    ...
    if(sp()!=0)return 20;else return 9;
}
private int _9(){
    gw(7,0,(gr(7,0)+6)%18);
    gw(8,0,(gr(8,0)+6)%18);
...
private int _11(){
    ...
    if((395-gr(2,0))>gr(2,1))return 19;else return 12;
}
private int _12(){
    sp();
    return 13;
...
private int _14(){
    ...
    if(gr(1,1)>gr(2,1))return 17;else return 15;
}
private int _15(){
    sa(sp()-1L);
    ...
    if(sp()!=0)return 4;else return 16;
}
private int _16(){
