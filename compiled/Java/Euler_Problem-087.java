...
class Program{
private final static String _g = "Ah+LCAAAAAAABADt2lVUG43WN/AKLS0UaIBC8eIOLRQLWghQ3N2KuweXUIpLcCgOwb24Q4uTIMU1uAR3t5fzPeeT6+99L8+++//W3rNn1syaNRdDEf7qyb8K7ckechBK"+
...
private long[]zc(byte[]b){long[]r=new long[1018000];for(int i=0;i<1018000;i++)r[i]=b[i];return r;}
...
private long gr(long x,long y){return(x>=0&&y>=0&&x<1000&&y<1018)?g[(int)(y*1000+x)]:0;}
private void gw(long x,long y,long v){if(x>=0&&y>=0&&x<1000&&y<1018)g[(int)(y*1000+x)]=v;}
...
private int _1(){
    ...
    if(sr()!=62)return 2;else return 3;
}
private int _2(){
    sa(sr());
    return 1;
...
private int _5(){
    ...
    if(sr()!=gr(3,0))return 24;else return 6;
}
private int _6(){
    gw(2,0,999);
    sp();
...
private int _8(){
    if((sr()+1)!=0)return 7;else return 9;
}
private int _9(){
    gw(9,0,50000000);
...
private int _12(){
    ...
    if(sr()!=gr(8,0))return 13;else return 14;
}
private int _13(){
    sa(sr());
    sa(2);
...
private int _14()throws java.io.IOException{
    System.out.print(String.valueOf(gr(5,0)));
    sp();
    return 29;
}
private int _15(){
...
private int _18(){
    ...
    if(sr()>gr(9,0))return 23;else return 19;
}
private int _19(){
    sa(sr());
    sa(sr());
    ...
    if((t1)!=0)return 22;else return 20;
}
private int _20(){
    sa(sr());
    sa(td(sr(),60));
...
private int _26(){
    if(sr()>=gr(3,0))return 28;else return 27;
}
private int _27(){
    sa(sr());
    sa(32);
