...
private int _1(){
    if(sp()!=0)return 55;else return 2;
}
private int _2(){
    sp();
    return 3;
...
private int _4(){
    ...
    if((sr()-gr(3,0))!=0)return 53;else return 5;
}
private int _5(){
    t0=gr(3,0)*gr(3,0);
    gw(4,1,gr(3,0));
    ...
    if((t0)!=0)return 6;else return 52;
}
private int _6(){
    gw(24,5,0);
    gw(24,4,0);
...
private int _7(){
    if(sp()!=0)return 51;else return 8;
}
private int _8(){
    gw(24,1,1);
    gw(24,4,1);
...
private int _10(){
    ...
    if(sp()!=0)return 50;else return 11;
}
private int _11(){
    sp();
    sa(15);
...
private int _15(){
    if(sp()!=0)return 49;else return 16;
}
private int _16(){
    gw(2,4,15);
    sp();
...
private int _18(){
    ...
    if(gr(3,4)!=9)return 48;else return 19;
}
private int _19(){
    t0=gr(2,4)-1;
    sp();

    if((gr(2,4))!=0)return 47;else return 20;
}
private int _20(){
    gw(1,4,0);
    gw(24,7,0);
...
private int _21(){
    if(sp()!=0)return 46;else return 22;
}
private int _22(){
    gw(2,4,15);
    sp();
...
private int _24(){
    ...
    if(gr(3,4)!=9)return 45;else return 25;
}
private int _25(){
    t0=gr(2,4)-1;
    sp();

    if((gr(2,4))!=0)return 44;else return 26;
}
private int _26(){
    sa(15);
    sa(gr(24,7)-gr(24,9));
...
private int _27(){
    if(sp()!=0)return 40;else return 28;
}
private int _28(){
    sa(sr()-1);
    {long v0=sp();long v1=sp();sa(v0);sa(v1);}

    if(sp()!=0)return 29;else return 30;
}
private int _29(){
    sa(sr());
    t0=gr(sr()+9,7);
...
private int _31(){
    if(sp()!=0)return 36;else return 32;
}
private int _32(){
    sp();
    sa(sp()+1L);
    ...
    if(sr()!=17)return 35;else return 33;
}
private int _33(){
    t0=gr(3,1)-999;
    gw(3,1,gr(3,1)+1);
    ...
    if((t0)!=0)return 3;else return 34;
}
private int _34(){
...
private int _36(){
    ...
    if(sp()!=0)return 37;else return 33;
}
private int _37(){
    gw(1,1,gr(3,1));
    gw(24,8,gr(24,2));
...
private int _38(){
    if(sp()!=0)return 39;else return 33;
}
private int _39(){
    sa(sr());
    sa(gr(sr()+9,2));
...
private int _41(){
    if(sp()!=0)return 42;else return 43;
}
private int _42(){
    sp();
    return 9;
...
private int _53(){
    if((sr()-gr(1,0))!=0)return 54;else return 5;
}
private int _54(){
    gw(1,0,gr(3,0));
    sa(sr());
