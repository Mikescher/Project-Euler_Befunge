...
private long[]zc(byte[]b){long[]r=new long[200256];for(int i=0;i<200256;i++)r[i]=b[i];return r;}
...
private long gr(long x,long y){return(x>=0&&y>=0&&x<112&&y<1788)?g[(int)(y*112+x)]:0;}
private void gw(long x,long y,long v){if(x>=0&&y>=0&&x<112&&y<1788)g[(int)(y*112+x)]=v;}
...
private int _5(){
    ...
    if((t0)!=0)return 3;else return 6;
}
private int _6(){
    gw(6,0,2);
