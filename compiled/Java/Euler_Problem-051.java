...
private int _1(){
    if(gr(0,2)!=1000)return 2;else return 46;
}
private int _2(){
    t0=gr(0,2)+1;
    t1=(gr(0,2)+1)%2;
    ...
    if((t1)!=0)return 3;else return 1;
}
private int _3(){
    t0%=5;

    if((t0)!=0)return 4;else return 1;
}
private int _4(){
    gw(1,2,3);
    return 5;
...
private int _7(){
    ...
    if((t0)!=0)return 8;else return 5;
}
private int _8(){
    gw(4,2,gr(0,2));
    sa(5);
...
private int _9(){
    if(sp()!=0)return 10;else return 45;
}
private int _10(){
    sa(sr());
    sa((gr(4,2)%10)+48);
...
private int _11(){
    ...
    if(sp()!=0)return 44;else return 12;
}
private int _12(){
    sp();
    sa(gr(12,gr(1,2))-48);
...
private int _13(){
    if(sp()!=0)return 43;else return 14;
}
private int _14(){
    sp();
    sa(sp()*10L);
    ...
    if((sr()%2)!=0)return 16;else return 15;
}
private int _15(){
    sp();
    return 7;
...
private int _16(){
    if((sr()%3)!=0)return 17;else return 15;
}
private int _17(){
    gw(5,2,sp());
    sa(7);
...
private int _19(){
    if(sr()>(gr(5,2)/2))return 22;else return 20;
}
private int _20(){
    sa(sr()-2);
    sa(gr(5,2));
...
private int _24(){
    if(sp()!=0)return 25;else return 42;
}
private int _25(){
    sa(sr());
    sa((gr(4,2)%10)+48);
...
private int _26(){
    ...
    if(sp()!=0)return 41;else return 27;
}
private int _27(){
    sp();
...
private int _28(){
    if(sp()!=0)return 40;else return 29;
}
private int _29(){
    sp();
    sa(sp()*10L);
    ...
    if((sr()%2)!=0)return 33;else return 30;
}
private int _30(){
    sp();
    sa(3);
    ...
    if(gr(9,2)!=9)return 23;else return 31;
}
private int _31(){
    sa(9);
    sa(2);
    ...
    if(gr(8,2)!=8)return 7;else return 32;
}
private int _32(){
...
private int _33(){
    if((sr()%3)!=0)return 34;else return 30;
}
private int _34(){
    gw(5,2,sp());
    sa(7);
...
private int _35(){
    if(sp()!=0)return 36;else return 30;
}
private int _36(){
    if(sr()>(gr(5,2)/2))return 39;else return 37;
}
private int _37(){
    sa(sr()-2);
    sa(gr(5,2));
    ...
    if(sp()!=0)return 38;else return 30;
}
private int _38(){
    sa(sp()+6L);
