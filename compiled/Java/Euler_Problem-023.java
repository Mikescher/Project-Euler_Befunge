...
private int _1(){
    ...
    if(sp()!=0)return 2;else return 22;
}
private int _2(){
    sa(sr());
    t0=gr(2,0);
    ...
    if((t1)!=0)return 21;else return 3;
}
private int _3(){
    sa(sr());
    gw(3,0,sp());
...
private int _6(){
    ...
    if(sp()!=0)return 20;else return 7;
}
private int _7(){
    gw(0,1,0);
    gw(4,0,gr(0,0));
...
private int _8(){
    ...
    if(sp()!=0)return 14;else return 9;
}
private int _9(){
    gw(8,0,0);
    gw(2,0,gr(0,0));
...
private int _10(){
    ...
    if(td(gr(tm(gr(2,0),gr(1,0)),(td(gr(2,0),gr(1,0)))+1),2)!=0)return 12;else return 11;
}
private int _11(){
...
private int _14(){
    if(tm(gr(tm(gr(4,0),gr(1,0)),(td(gr(4,0),gr(1,0)))+1),2)!=0)return 15;else return 8;
}
private int _15(){
    gw(5,0,gr(4,0)+1);
    return 16;
...
private int _17(){
    if(tm(gr(tm(gr(5,0),gr(1,0)),(td(gr(5,0),gr(1,0)))+1),2)!=0)return 18;else return 16;
}
private int _18(){
    if((gr(4,0)+gr(5,0))>gr(0,0))return 16;else return 19;
}
private int _19(){
